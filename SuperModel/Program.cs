        ...
        static int Main(string[] args)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(assembly))
                {
                    ...
                    {
                        dynamic model = null;
                        modelMap.TryGetValue(cls.Name, out model);
                        model = BuildModelFromPoco(model, cls, idPropertyName);
                    }
                }
...
#region Assembly modelling
        ...
        private static dynamic BuildModelFromPoco(dynamic model, Type cls, string idPropertyName)
        {
            if (model == null)
